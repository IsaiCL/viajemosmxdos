<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('tours.index') }}" :active="request()->routeIs('tours')">
                        {{ __('Tours') }}
                    </x-jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- El ".index" agregado con el nombre de la ruta hace referencia a la primera vista del controlador de la ruta,
            en este caso categorias y tours --> 

            <x-jet-responsive-nav-link href="{{ route('categorias.index') }}" :active="request()->routeIs('categorias')">
                {{ __('Categorías') }}
            </x-jet-responsive-nav-link>

            <x-jet-responsive-nav-link href="{{ route('tours.index') }}" :active="request()->routeIs('tours')">
                {{ __('Tours') }}
            </x-jet-responsive-nav-link>
            @endif
        </div>
